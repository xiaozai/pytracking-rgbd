...
def parameters():
    ...
    params.merge_type = 'mean'

    params.net = NetWithBackbone(net_path='/home/sgn/Data1/yan/pytracking-models/checkpoints/ltr/dimp/dimp50D_RGBColormap_postmerge_DepthTrack_mean/ep0075.pth.tar',
