...
def parameters():
    ...
    #                              use_gpu=params.use_gpu)
    params.net = NetWithBackbone(net_path='/home/sgn/Data1/yan/pytracking-models/checkpoints/ltr/dimp/dimp50_D_CDTB_finetune_generated_PP_new02/DiMPnet_ep0150.pth.tar',
                                 use_gpu=params.use_gpu)
