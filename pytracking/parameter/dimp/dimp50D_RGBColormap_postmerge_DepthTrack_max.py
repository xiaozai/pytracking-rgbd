...
def parameters():
    ...
    params.net = NetWithBackbone(net_path='/home/sgn/Data1/yan/pytracking-models/checkpoints/ltr/dimp/dimp50D_RGBColormap_postmerge_DepthTrack_max/ep0060.pth.tar',
