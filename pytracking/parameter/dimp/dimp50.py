...
def parameters():
    ...
    # params.net = NetWithBackbone(net_path='/home/yan/Data2/pytracking-models/ltr/checkpoints/ltr/dimp/dimp50D_colormap/dimp50D_colormap.pth.tar',
    #                              use_gpu=params.use_gpu)

    params.net = NetWithBackbone(net_path='/home/yan/Data2/pytracking-models/ltr/checkpoints/ltr/dimp/dimp50D_normD/dimp50D_normD.pth.tar',
                                 use_gpu=params.use_gpu)
