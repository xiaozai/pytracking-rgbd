...
def parameters():
    ...
    deep_feat = deep.ATOMResNet18(net_path='/home/yans/pytracking-models/ltr/checkpoints/ltr/bbreg/atom_depth/ATOMnet_ep0050.pth.tar', output_layers=['layer3'], fparams=deep_fparams,
                                  normalize_power=2)
