...
class CDTBDepthValDataset(BaseDataset):
    """
    CDTB, Depth only dataset
    """
    def __init__(self):
        super().__init__()
    ...
    def _construct_sequence(self, sequence_name):
        ...
        return Sequence(sequence_name, frames, 'cdtb_depth_val', ground_truth_rect, is_depth=True, depth_threshold=8000)
