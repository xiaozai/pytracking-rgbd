...
def run(settings):
    ...
    lasot_depth_train = Lasot_depth(root=settings.env.lasotdepth_dir, rgb_root=settings.env.lasot_dir, dtype='depth')

    # Validation datasets
    # got10k_val = Got10k(settings.env.got10k_dir, split='votval')
    cdtb_val = CDTB_depth(settings.env.cdtb_dir, split='val', dtype='depth')
    ...
    dataset_val = sampler.DiMPSampler([cdtb_val], [1], samples_per_epoch=5000, max_gap=30,
