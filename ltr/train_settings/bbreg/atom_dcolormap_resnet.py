...
def run(settings):
    ...
    settings.description = 'ATOM IoUNet with default settings, ResNet without pretrain but additionally using CDTB colormap for training from scratch.'
    ...
    net = atom_models.atom_resnet18(backbone_pretrained=False) # Song !!!!!!!!!!
