...
from ltr.dataset import Lasot, TrackingNet, MSCOCOSeq, Got10k, CDTB, DepthTrack
...
def run(settings):
    ...
    dataset_train = sampler.ATOMSampler([depthtrack_train, depthtrack_horizontal_train, depthtrack_vertical_train], [1, 0.25, 0.25],
