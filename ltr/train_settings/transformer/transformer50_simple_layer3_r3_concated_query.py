...
from ltr.models.transformer import detr_roi, detr_roi_query, detr, detr_simple, detr_concated_query
...
def run(settings):
    ...
    net = detr_concated_query.build_tracker(backbone_name='resnet50',
