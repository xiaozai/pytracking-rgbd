...
class ResNet_depthaware(Backbone):
    """ ResNet network module. Allows extracting specific feature blocks.

    Depth-aware convolution layers :
...
def resnet50_depthaware(output_layers=None, pretrained=False, **kwargs):
    """Constructs a ResNet-50 model.

        with depth_aware conv
        Conv3_1, Conv4_1, Conv5_1 are replaced with depth-aware convolution
    """
