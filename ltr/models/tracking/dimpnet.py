...
@model_constructor
def simplenet_backbone(filter_size=1, optim_iter=5, optim_init_step=1.0, optim_init_reg=0.01,
    ...
    # Backbone
    backbone_net = backbones.simplenet(pretrained=backbone_pretrained, frozen_layers=frozen_backbone_layers)
...
@model_constructor
def alexnet_backbone(filter_size=1, optim_iter=5, optim_init_step=1.0, optim_init_reg=0.01,
            classification_layer='layer3', feat_stride=16, backbone_pretrained=True, clf_feat_blocks=0,
            clf_feat_norm=True, init_filter_norm=False, final_conv=True,
            out_feature_dim=512, init_gauss_sigma=1.0, num_dist_bins=5, bin_displacement=1.0,
            mask_init_factor=4.0, iou_input_dim=(256, 256), iou_inter_dim=(256, 256),
    ...
    # Backbone
    backbone_net = backbones.alexnet(pretrained=backbone_pretrained, frozen_layers=frozen_backbone_layers)
...
@model_constructor
def vggm_backbone(filter_size=1, optim_iter=5, optim_init_step=1.0, optim_init_reg=0.01,
            classification_layer='layer3', feat_stride=16, backbone_pretrained=True, clf_feat_blocks=0,
            clf_feat_norm=True, init_filter_norm=False, final_conv=True,
            out_feature_dim=512, init_gauss_sigma=1.0, num_dist_bins=5, bin_displacement=1.0,
            mask_init_factor=4.0, iou_input_dim=(256, 256), iou_inter_dim=(256, 256),
    ...
    # Backbone
    backbone_net = backbones.vggm(pretrained=backbone_pretrained, frozen_layers=frozen_backbone_layers)
